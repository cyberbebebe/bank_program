...
def register_client():
    ...
    def submit_registration():
        ...
        if name_entry.get() == "" or dob_entry.get() == "" or contact_entry.get() == "" or address_entry.get() == "":
            ...
            existing_client = next((c for c in data["clients"] if c["Full name"] == client["Full name"] and
                                    c["Date of birth"] == client["Date of birth"] and
...
def deposit_withdraw():
    ...
    def submit_action():
        ...
        for client in data["clients"]:
            if (client["Full name"] == full_name and client["Date of birth"] == dob and client["Contact information"] == contact_info and client["Residential address"] == address):
                client = client
                break
